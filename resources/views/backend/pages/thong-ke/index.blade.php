                ...
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">List Products</h5>
                            <p class="card-subtitle mb-0">List Products</p>
                        </div>
                        <div>
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        @if($user)
                                            <p class="mb-0 fs-3">{{$user->name}}</p>
                                        @endif
                                    </td>
                                    <td>
                                        <p class="mb-0 fs-3">{{$product->gia_khuyen_mai}}</p>
                                    </td>
                                    <td>
                                        <p class="fs-3 text-dark mb-0 {{ $product->status == 1 ? 'text-success' : 'text-danger'}}">
                                            {{ $product->status == 1 ? 'Kích hoạt' : 'Hủy kích hoạt'}}
                                        </p>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="col-lg-6 d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">List Spa</h5>
                            <p class="card-subtitle mb-0">Best Spa</p>
                        </div>
                        <div>
                            <select class="form-select">
                                <option value="1">March 2023</option>
                        ...
                        <table class="table align-middle text-nowrap mb-0">
                            ...
                            @foreach($spas as $user)
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0 fs-3">{{$user->number_phone}}</p>
                                    </td>
                                    <td>
                                        <p class="fs-3 text-dark mb-0">{{ $user->status == 1 ? 'Kích hoạt' : 'Hủy kích hoạt'}}</p>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
        ...
        <div class="col-lg-12 d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">List Orders</h5>
                            <p class="card-subtitle mb-0">List Orders</p>
                        </div>
                        <div>
                            <select class="form-select">
                                <option value="1">March 2023</option>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle text-nowrap mb-0">
                            <thead>
                            <tr class="text-muted fw-semibold">
                                <th scope="col" class="ps-0">Order Code</th>
                                <th scope="col">Spa Onwer</th>
                                <th scope="col">Author</th>
                                <th scope="col">Email</th>
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    <td class="ps-0">
                                        <h6 class="fw-semibold mb-1">{{$order->ma_don_hang}}</h6>
                                    </td>
                                    <td>
                                        @php
                                            $user = \App\Models\User::find($order->id_chu_spa)
                                        @endphp
                                        @if($user)
                                            <p class="mb-0 fs-3">{{$user->name}}</p>
                                        @endif
                                    ...
                                    <td>
                                        @php
                                            $user = \App\Models\User::find($order->id_nguoi_dat)
                                        @endphp
                                        @if($user)
                                            <p class="mb-0 fs-3">{{$user->name}}</p>
                                        @endif
                                    ...
                                    <td>
                                        <p class="mb-0 fs-3">{{$order->email}}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 fs-3">{{$order->number_phone}}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 fs-3">{{$order->price}}</p>
                                    </td>
                                    <td>
                                        <p class="fs-3 text-dark mb-0 {{ $order->status == 1 ? 'text-success' : 'text-danger'}}">
                                            {{ $order->status == 1 ? 'Kích hoạt' : 'Hủy kích hoạt'}}
                                        </p>
                                    </td>
                                </tr>
                            @endforeach
